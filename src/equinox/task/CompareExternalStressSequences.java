...
public class CompareExternalStressSequences extends InternalEquinoxTask<CategoryDataset> implements ShortRunningTask, MultipleInputTask<ExternalStressSequence>, AutomaticTaskOwner<Pair<CategoryDataset, StatisticsPlotAttributes>> {
	...
	@Override
	synchronized public void addAutomaticInput(AutomaticTaskOwner<ExternalStressSequence> task, ExternalStressSequence input, ExecutionMode mode) {
		automaticInputAdded(task, input, mode, stressSequences_, inputThreshold_);
	}

	@Override
	synchronized public void inputFailed(AutomaticTaskOwner<ExternalStressSequence> task, ExecutionMode mode) {
